# Front End: BeyondPlay Technical Assignment

This is the front-end part of the BeyondPlay Technical Assignment, developed using Create React App.

## Getting Started

To set up the front-end environment for the BeyondPlay Technical Assignment, follow these steps:
...
- **Building for Production**: Run `npm run build` to build the app for production. The build artifacts will be stored in the `build` folder.
